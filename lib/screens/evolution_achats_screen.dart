// lib/screens/evolution_achats_screen.dart
...
class EvolutionAchatsScreen extends StatelessWidget {
  final List<TableauBordAchatsVentes> dataList;
  final DateTime startDate;
  final DateTime endDate;

  const EvolutionAchatsScreen({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Évolution des Achats'),
      ...
      body: Padding(
        ...
        child: dataList.isEmpty
            ? const Center(child: Text('Aucune donnée d\'achat à afficher.'))
            : Column(
          children: [
            Expanded(
              child: LineChart(
                LineChartData(
                  ...
                  lineBarsData: [
                    _lineChartBarData(spotsAchats, Colors.deepOrange.shade600, 'Achats'),
                  ],
                      ...
                      getTooltipItems: (List<LineBarSpot> touchedBarSpots) {
                        return touchedBarSpots.map((barSpot) {
                          ...
                          return LineTooltipItem(
                            'Achats\n',
                            TextStyle(color: Colors.deepOrange.shade600.darker(0.2), fontWeight: FontWeight.bold, fontSize: 12),
                            children: [
                              TextSpan(
            ...
            _legendItem(Colors.deepOrange.shade600, "Achats"),
          ],
        ),
      ),
    );
